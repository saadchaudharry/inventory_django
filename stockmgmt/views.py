...
from .form import StockCreateForm, StockSearchForm, StockUpdateForm, IssueForm, ReceiveForm, ReorderLevelForm, StockHistorySearchForm
...
def list_item(request):
    ...
    if request.method == 'POST':
        queryset = Stock.objects.filter(category=form['category'].value(),
                                        item_name__contains=form['item_name'].value())
...
def reorder_level(request, pk):
    ...
    if form.is_valid():
        ...
        return redirect("list_item")
    context = {"title": 'Reorder level of ' + str(queryset.item_name),"instance": queryset, "form": form, }
    return render(request, "add_item.html", context)
